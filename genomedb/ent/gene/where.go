...
func ID(id string) predicate.Gene {
...
func IDEQ(id string) predicate.Gene {
	return predicate.Gene(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id string) predicate.Gene {
	return predicate.Gene(func(s *sql.Selector) {
...
func IDIn(ids ...string) predicate.Gene {
	return predicate.Gene(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDNotIn(ids ...string) predicate.Gene {
	return predicate.Gene(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id string) predicate.Gene {
	return predicate.Gene(func(s *sql.Selector) {
...
func IDGTE(id string) predicate.Gene {
	return predicate.Gene(func(s *sql.Selector) {
...
func IDLT(id string) predicate.Gene {
	return predicate.Gene(func(s *sql.Selector) {
...
func And(predicates ...predicate.Gene) predicate.Gene {
	return predicate.Gene(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Or(predicates ...predicate.Gene) predicate.Gene {
	return predicate.Gene(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Not(p predicate.Gene) predicate.Gene {
	return predicate.Gene(func(s *sql.Selector) {
		p(s.Not())
	})
}
