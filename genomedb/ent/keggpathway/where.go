...
func ID(id string) predicate.KeggPathway {
...
func IDEQ(id string) predicate.KeggPathway {
	return predicate.KeggPathway(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id string) predicate.KeggPathway {
	return predicate.KeggPathway(func(s *sql.Selector) {
...
func IDIn(ids ...string) predicate.KeggPathway {
	return predicate.KeggPathway(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDNotIn(ids ...string) predicate.KeggPathway {
	return predicate.KeggPathway(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id string) predicate.KeggPathway {
	return predicate.KeggPathway(func(s *sql.Selector) {
...
func IDGTE(id string) predicate.KeggPathway {
	return predicate.KeggPathway(func(s *sql.Selector) {
...
func IDLT(id string) predicate.KeggPathway {
	return predicate.KeggPathway(func(s *sql.Selector) {
...
func And(predicates ...predicate.KeggPathway) predicate.KeggPathway {
	return predicate.KeggPathway(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Or(predicates ...predicate.KeggPathway) predicate.KeggPathway {
	return predicate.KeggPathway(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Not(p predicate.KeggPathway) predicate.KeggPathway {
	return predicate.KeggPathway(func(s *sql.Selector) {
		p(s.Not())
	})
}
