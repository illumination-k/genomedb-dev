...
const (
	// Label holds the string label denoting the threeprimeutr type in the database.
	...
	// Table holds the table name of the threeprimeutr in the database.
	Table = "three_prime_utrs"
	// TranscriptTable is the table that holds the transcript relation/edge.
	TranscriptTable = "three_prime_utrs"
	...
	TranscriptColumn = "transcript_three_prime_utr"
)

// Columns holds all SQL columns for threeprimeutr fields.
var Columns = []string{
	FieldID,
	FieldSeqname,
	FieldStart,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "three_prime_utrs"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"transcript_three_prime_utr",
}
